...
class zone extends \ClicShopping\Apps\Shipping\Flat\Module\ClicShoppingAdmin\Config\ConfigParamAbstract {
    public $default = '0';
    public $sort_order = 250;

    protected function init()
    {
        $this->title = $this->app->getDef('cfg_flat_zone_title');
        $this->description = $this->app->getDef('cfg_flat_zone_desc');
    }

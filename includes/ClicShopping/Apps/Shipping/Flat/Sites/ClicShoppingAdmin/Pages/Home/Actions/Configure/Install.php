<?php
  ...
  class Install extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_Flat->loadDefinitions('Sites/ClicShoppingAdmin/install');
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_Flat->getDef('alert_module_install_success'), 'success', 'Flat');
    ...
    private static function installDbMenuAdministration()
    {
      ...
      if ($Qcheck->fetch() === false) {
        ...
        $sql_data_array = ['sort_order' => 4,
          'link' => 'index.php?A&Shipping\Flat&Configure&module=FL',
          'image' => 'modules_shipping.gif',
          'b2b_menu' => 0,
          'access' => 1,
          'app_code' => 'app_shipping_flat'
        ];
        ...
        for ($i = 0, $n = count($languages); $i < $n; $i++) {
          ...
          $sql_data_array = ['label' => $CLICSHOPPING_Flat->getDef('title_menu')];

    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_Flat->getDef('button_sort_order'), null, CLICSHOPPING::link(null, 'A&Configuration\Modules&Modules&set=shipping'),  'primary'); ?>
        </div>
      </div>
    </div>
  </div>
